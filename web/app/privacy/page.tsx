    ...
    <main className="min-h-screen">
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="space-y-8 text-sm text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-3">What data we collect</h2>
            <p className="mb-3">
              <strong className="text-white">Article text you submit.</strong> When you analyze
            ...
            <p>
              <strong className="text-white">That's it.</strong> We do not collect your name,
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-3">What data we do not collect</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-3">Chrome extension — local storage</h2>
            <p>
              The Chrome extension caches analysis results locally on your device (using
              Chrome's <code className="text-blue-400">chrome.storage.local</code> API) for up
          ...
          <section>
            ...
            <p className="mb-3">
              <strong className="text-white">Anthropic (Claude AI).</strong> Article text you
            ...
            <p>
              <strong className="text-white">Vercel.</strong> The SpinCheck website and API are
